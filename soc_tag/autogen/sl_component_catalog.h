...
#define SL_CATALOG_BLUETOOTH_FEATURE_AOA_TRANSMITTER_PRESENT
...
#define SL_CATALOG_GATT_SERVICE_CTE_PRESENT
#define SL_CATALOG_GATT_SERVICE_CTE_ADV_PRESENT
#define SL_CATALOG_GATT_SERVICE_CTE_CONNECTIONLESS_PRESENT
